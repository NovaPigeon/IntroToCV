...
if __name__ == "__main__":
    ...
    for i in range(50):
        ...
        # dL/d_output_layer2=(dL/d_pred_y)*(dpred_y/d_output_l2)
        grad_output_layer2=grad_pred_y*pred_y*(1-pred_y)
        grad_layer_2=output_layer_1_act.T.dot(grad_output_layer2)
        grad_output_layer1_act=grad_output_layer2.dot(MLP_layer_2.T)
        grad_output_layer1=grad_output_layer1_act*output_layer_1_act*(1-output_layer_1_act)
        grad_layer_1=input_vector.T.dot(grad_output_layer1)
